...
<div id="mainbox">
       ...
       <tbody><tr align="center">
        ...
        <td class="f1" width="86">
         	<form action="statistics.jsp" method="post">
    			<a href="#" onclick="document.forms[3].submit();return false;">Statistics</a>
			</form>
		</td>
 ...
 <div class="b_l">
        <div class="l_1"><div class="a1">Your Profile</div><div class="m1"></div></div>
<div class="l_2">
                  ...
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      ...
                      <td width="594"><table width="99%" border="0" cellpadding="0" cellspacing="0">
                          <tbody><tr>
                            <td class="n_time"><%User u1 =((User)session.getAttribute("user")); out.print(u1.getUsername()); %></td>
                          </tr>
                          <tr>
                            <br />
   ...
   <div name="content_id0" id="content_id0" class="style7">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      ...
                      <td width="594"><table width="99%" border="0" cellpadding="0" cellspacing="0">
                          <tbody><tr>
                            <td class="n_time"><%= u1.getEmail() %></td>
                          </tr>
                          <tr>
                            <br />
   ...
   <div name="content_id0" id="content_id0" class="style7">
                  <table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tbody><tr>
                      ...
                      <td width="594"><table width="99%" border="0" cellpadding="0" cellspacing="0">
                          <tbody><tr>
                            <td class="n_time"><%= u1.getLosses() %></td>
                          </tr>
                          <tr>
                            <br />
